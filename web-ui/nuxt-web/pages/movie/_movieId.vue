      ...
      <el-col :md="18" :xs="24" :sm="24">
        ...
        <div>
          <el-card>
            ...
            <atargetIde class="c-attr-wrap">
              <section class="ml20 mr15">
                <h2 class="hLh30 txtOf mt15">
                  <span class="c-fff fsize24">{{movie.title}}</span>
                </h2>
                <section class="c-attr-mt10 c-attr-undis">
                  <span class="c-fff fsize14">类型：&nbsp;{{selectDictLabel(typeOptions, movie.type)}}</span>&nbsp;&nbsp;
                  <span class="c-fff fsize14">分类：&nbsp;{{ movie.categoryName ?movie.categoryName: '无' }}</span>&nbsp;&nbsp;
                </section>
                ...
                <section class="c-attr-mt10 c-attr-undis">
                  ...
                  <span class="c-fff fsize14" v-if="!actorList || actorList.length === 0">无</span>
                  <span class="c-fff fsize14" v-for="actor in actorList" :key="actor.actorId">
                 {{ actor.name }}&nbsp;</span>
                </section>
                <section class="c-attr-mt10 c-attr-undis">
                  <span class="c-fff fsize14">标签：&nbsp;
                    <el-tag
                      size="mini"
          ...
          <el-menu
            ...
            <el-submenu index="0">
              ...
              <el-menu-item   :index="`/video/` + video.videoId" v-for="video in videoList" :key="video.videoId" >
                <span class="fsize12">{{ video.title | ellipsis(20) }} <i  class="free-icon vam">免费观看</i></span>
              </el-menu-item>
...
export default {
  ...
  async asyncData({ params, error }) {
    ...
    return { movieId: movieId,
              ...
              statusOptions: dictDataList.data.movie_status,
              typeOptions: dictDataList.data.movie_type,
