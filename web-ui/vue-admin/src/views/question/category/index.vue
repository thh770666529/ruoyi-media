...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory } from "@/api/question/category";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除问答分类编号为"' + categoryIds + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('question/category/export', {
        ...this.queryParams
