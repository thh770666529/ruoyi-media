<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['question:category:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分类内容" align="center" prop="content" />
...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory, exportCategory } from "@/api/question/category";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除问答分类编号为"' + categoryIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有问答分类数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
