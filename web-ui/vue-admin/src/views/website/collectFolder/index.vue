    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['website:collectFolder:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['website:collectFolder:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['website:collectFolder:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map(item => item.collectFolderId)
    ...
    handleUpdate(row) {
      this.reset();
      const collectFolderId = row.collectFolderId || this.ids
      getCollectFolder(collectFolderId).then(response => {
